    ...
    <div className={styles.profilingFeatures}>
        <div className={styles.leftSide}>
            ...
            <div className={styles.columnSection}>
                ...
                <p className={styles.subsectDescription}>Link to your Open Telemetry tracing data and get <br />request-specific or span-specific profiles to enhance <br />other observability data like traces and logs</p>
            </div>
        </div>
