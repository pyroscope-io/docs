    ...
    return (
      <Layout title="Pricing Pyroscope">
        ...
        <linearGradient id="myGradient" gradientTransform="rotate(45)">
          {/* <stop offset="5%"  stopColor="#FE883E" />
          <stop offset="95%" stopColor="#FF5084" /> */}
          <stop offset="5%"  stopColor="#C7F6FC" />
          <stop offset="95%" stopColor="#5CD3E3" />
        </linearGradient>
        </svg>
        ...
        <div className={styles.background}>
          ...
          <section className={clsx(styles.pricingTableSection, indexStyles.brighterSection)}>
            <div className="container">
              <h1>Compare Plans</h1>
