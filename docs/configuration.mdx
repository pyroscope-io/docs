...
## Data retention
See the [data retention](data-retention) page for more details on how to configure retention policies.

## Metrics export rules
See the [metrics export](metrics-export) page for more details on how to export profiling data as Prometheus metrics.

## Scraping
See the [pull mode](pull-mode) page for more details on how to configure remote targets scraping.
