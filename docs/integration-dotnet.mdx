...
1. Go to [Pyroscope Cloud API Keys page](https://pyroscope.cloud/settings/api-keys)
2. Copy one of the keys
3. Add it to your .NET profiler configuration: `PYROSCOPE_AUTH_TOKEN="psx-..."`
