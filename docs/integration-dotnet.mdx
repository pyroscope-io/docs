...
This is a documentation for our dotnet integration. It is based on [dd-trace-dotnet](https://github.com/DataDog/dd-trace-dotnet).
...
To configure .NET agent to send data to Phlare, replace the `<URL>` placeholder with the appropriate server URL. This could be the grafana.com Phlare URL or your own custom Phlare server URL.
