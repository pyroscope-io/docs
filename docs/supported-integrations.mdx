...
|:--------------------:|:------------:|:------------:|:-----:|:-----:|:-------:|:------:|
| [**eBPF**](ebpf)     | ebpfspy      | `embedded`   |   ✅  |       |         |   ✅   |
| [**Go**](golang)     | n/a          | `standalone` |   ✅  |   ✅  |    ✅   |   ✅   |
| [**PHP**](php)       | phpspy       | `embedded`   |   ✅  |       |         |   ✅   |
| [**Python**](python) | pyspy        | `embedded`   |   ✅  |   ✅  |         |   ✅   |
| [**Ruby**](ruby)     | rbspy        | `embedded`   |   ✅  |   ✅  |         |   ✅   |
| [**.NET**](dotnet)   | dotnetspy    | `embedded`   |   ✅  |   ✅  |    ✅   |   ✅   |
...
If you want to contribute, please check out [Creating New Integrations](new-integrations) page.
