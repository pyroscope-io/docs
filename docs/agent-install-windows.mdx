...
**Pyroscope Agent** is installed as a system service which is started automatically ([`pyroscope agent`](agent-configuration-agent) command). To make sure the service was
