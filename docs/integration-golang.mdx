...
title: Go Integration (Push Mode)
...
import IntegrationHeader from '../src/components/IntegrationHeader';

<IntegrationHeader
  demoURL="https://golang-push-rideshare.examples.pyroscope.io/"
  blogURL="https://pyroscope.io/blog/profiling-go-apps-with-pyroscope/"
  youtubeURL="https://www.youtube.com/embed/zy5W79Hbq4c"
  sourceURL="https://github.com/pyroscope-io/pyroscope/tree/main/examples/golang-push"
/>
