...
:::tip
We strongly recommend you to integrated with Pyroscope using this method.
:::
...
[API Key authentication](/auth-overview.mdx/#api-key-authentication) should be used to authenticate the calling service.
...
Although, the configuration supposes that the pyroscope server is called from **https://your.site.com** origin,
