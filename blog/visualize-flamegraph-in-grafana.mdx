...
4. Give a [sneak peak](/blog/visualize-flamegraphs-in-grafana/#sneak-peak-at-whats-next-for-pyroscope-x-grafana-integration) of an upcoming feature that wil let you link profiles to logs, metrics, and traces
