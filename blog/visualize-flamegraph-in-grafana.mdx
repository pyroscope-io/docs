...
To install the panel plugin, first navigate to your Grafana directory using your terminal.
...
If you’re interested in seeing the Pyroscope Grafana plugin in action, check out the [example](https://github.com/pyroscope-io/pyroscope/tree/main/examples/grafana-integration) from the Pyroscope repo.
...
Here's a preview of what that ends up looking like in practice. Stay tuned for more info on our upcoming (official) release of this feature or if you want to try it out yourself try our [tracing examples](https://github.com/pyroscope-io/pyroscope/tree/main/examples/tracing/jaeger) from the repo.
