...
- We use [ruby gem](https://pyroscope.io/docs/ruby/), [pip package](https://pyroscope.io/docs/python/), [go client](https://pyroscope.io/docs/golang/), and [java client](https://pyroscope.io/docs/java/) _with tags_ for our k8s services and github action test suites.
- We use our [lambda extension](https://pyroscope.io/docs/aws-lambda/) to profile the code inside lambda functions
