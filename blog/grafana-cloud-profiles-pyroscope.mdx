...
We are thrilled to inform you that Pyroscope Cloud will no longer be accepting new signups. Instead, we invite you to join us
...
Step 1: Log into your [Grafana Cloud account](https://grafana.com/products/cloud/?pg=blog&plcmt=body-txt). (If you don’t already have one, you can sign up for free. )

Step 2: Find **Pyroscope** in your stacks

![pyroscope_stack](https://grafana.com/media/blog/cloud-profiles-public-preview/cloud-profiles-in-grafana-ui2.png)

Step 3: Follow the client instructions on [how to send profiles from your application](https://grafana.com/docs/phlare/latest/configure-client/?pg=blog&plcmt=body-txt)
