...
![Screenshot 2023-01-24 at 12 18 08 PM](https://user-images.githubusercontent.com/662636/214399512-7cd2e98f-6ee3-4d9f-ad73-5969d23ef149.png)

<i>
TODO: add description and find a better screenshot
</i>
</center>
<br/>

In general, it's a good idea to profile your program to see if your program suffers from garbage collection overhead and could benefit from arenas. Once you've identified a bottleneck, you can experiment with using arenas to see if they result in improved performance. For example, the screenshot above is a good example of an application that is a good candidate for using arenas because a large chunk of time is spent in garbage collection.
