---
title: Profiling in Python with Pyroscope's Pip Package
sidebar_label: Profiling with Pyroscope's Pip Package
slug: /profiling-with-pyroscopes-pip-package
---
...
### Running the [example](https://github.com/pyroscope-io/pyroscope/tree/main/examples/python)
