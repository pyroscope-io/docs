...
Here's an example of how to do this in [insert your programming language or test framework]:
...
initialize and then remove the profiler. Here's an example of how to do this in [insert your programming language or test framework]:
