...
Profiling your code as part of your CI/CD pipeline can also help with early issue detection. When test suites start running more slowly, it likely
means there are newly introduced code regressions or performance issues. Catching these issues early can help you identify and fix problems 
