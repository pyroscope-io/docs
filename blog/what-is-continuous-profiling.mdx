...
At Pyroscope, we actually [profile our own servers using Pyroscope](https://pyroscope.io/blog/profile-continuous-profiler/) and have found many cases where profiling has saved us a lot of time and money by identifying performance issues. Pyroscope allows: 
