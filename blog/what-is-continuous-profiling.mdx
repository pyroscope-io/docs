...
![user_personas_05-01](https://user-images.githubusercontent.com/29557702/165460236-535fcd61-6749-4eaa-ad32-0b7ac7e9017a.png)
...
Pyroscope is open-source which means that it’s easier to get started and try out than cloud providers profilers. Pyroscope’s [custom storage engine](docs/storage-design/) is language-agnostic so _any profiling data_ ranging from [rbspy](https://rbspy.github.io/) to [eBPF](https://ebpf.io/) to even new profilers such as Bloomberg's [Memray](https://bloomberg.github.io/memray/) data can easily send data to Pyroscope and have it compressed, stored and queried efficiently. 
