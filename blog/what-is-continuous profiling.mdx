...
![browser-profiler](https://user-images.githubusercontent.com/29557702/165289655-58cd9a0b-8848-4e03-b7e5-afdf822cf577.png)
...
![gwp-diagram-edited](https://user-images.githubusercontent.com/29557702/165291203-68d7acff-4b05-41f9-9d24-9ea4bb4fa48d.png)
...
Since then, many major performance monitoring solutions have joined them in releasing continuous profiling products. At the same time, many other companies and VCs are making major investments in Continuous Profiling as well to catch up to the popular demand for this tool.

![cp_timeline_08-01](https://user-images.githubusercontent.com/29557702/165291672-88805173-4bf4-4029-9b6c-3b31951733bd.png)
...
![Screenshot 2022-04-25 at 06 46 47](https://user-images.githubusercontent.com/29557702/165292882-6a51fb4b-35bb-463a-805f-e9f7997f871d.png)
...
![Screenshot 2022-04-25 at 06 50 50](https://user-images.githubusercontent.com/29557702/165292984-a0219d7e-f4cc-4db8-8b45-818c1e7485c4.png)
...
<img width="601" alt="Screenshot 2022-04-25 at 19 13 32" src="https://user-images.githubusercontent.com/29557702/165293723-4ab25678-0d07-495e-b3b5-61318c337d80.png">
...
![Screenshot 2022-04-25 at 06 46 18](https://user-images.githubusercontent.com/29557702/165293941-d1e4dc06-a831-417a-8e17-ad76ce5f9ac2.png)
...
At Pyroscope, we actually profile our own servers using Pyroscope and have found many cases where profiling has saved us a lot of time and money by identifying performance issues. Pyroscope allows: 

- Developers
  - Understand the call tree of their application
  - Locate and fix memory leaks
  - Resolve issues with high CPU utilization
- Engineering Managers
  - Easily spot performance regression in their codebase
  - 360 performance coverage of their infrastructure
  - Create a performance-driven culture where performance testing is carried out throughout the software development cycle.
- Executives
  - Have access to performance insight for better decision making
  - Reduce cost allocation for computing resources
  - Get real-time analysis of their compute resource utilization

Pyroscope also provides you with multi-language support, ad-hoc profiling, profile sharing, and more!

<img width="1771" alt="Screenshot 2022-04-25 at 15 58 36" src="https://user-images.githubusercontent.com/29557702/165295656-2a693a49-55da-46ce-a317-f5bc02b66ab9.png">

## What makes Pyroscope unique?
Pyroscope is open-source which means that it’s easier to get started and try out than cloud providers profilers. Pyroscope’s custom storage engine is language-agnostic so profilers such as Rbspy, eBPF, and even Bloomberg's new memory profiler Memray, can easily send data to Pyroscope and have it stored and queried efficiently. Pyroscope is also built to be easy to use by everyone. The pyroscope UI in particular was designed to be super intuitive for anyone to play around, analyze, and understand profiles.
...
Given my experience with profiling in the browser, the easiest way for me to get started with continuous profiling was to install pyroscope. To learn how to perform continuous profiling in your code or application, I would suggest you run the [examples in the examples folder on GitHub](https://github.com/pyroscope-io/pyroscope/tree/main/examples). 
