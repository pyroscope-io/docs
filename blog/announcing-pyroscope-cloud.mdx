...
We started Pyroscope a few years ago, because we had seen, first-hand, how profiling was a powerful tool for improving performance, but it was also a very difficult tool to use.
...
Since then, we've seen Pyroscope evolve to support a wide array of our community's day-to-day workflows to add a valuable extra dimension to their observability stack:
