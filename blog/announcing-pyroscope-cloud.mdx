...
- Software engineers: Using Pyroscope to write more performant code, understand their impact on application performance, and debug performance issues
- Devops engineers: Using Pyroscope to allocate resources more efficiently when scaling infrastructure alongside the business
- Engineering Managers and executives: Using Pyroscope to understand the performance of their teams and improve collaboration through a shared understanding of their applications performance
- And many more!
...
[image of vertical scalability (with badger) vs Horizontal scalability (with s3) ]
